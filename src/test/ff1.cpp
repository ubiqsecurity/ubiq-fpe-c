              ...
              const char * const radix_str)
{
    ...
    res = ff1_ctx_create_custom_radix(&ctx, K, k, T, t, 0, SIZE_MAX, radix_str);
    EXPECT_EQ(res, 0);
    if (res == 0) {
        EXPECT_EQ(ff1_encrypt(ctx, out, PT, NULL, 0), 0);
        EXPECT_EQ(strcmp(out, CT), 0) << "  out(" << out << ")   CT(" << CT << ")";
...
TEST(ff1, base2_a)
{
    ...
    const char PT[] = "000010101100011111010000111001100001011010011110100100110010010000000101000011000000001111110101111100111001001001100100100110101111110000011101010111001111010000010010111110101100001001100011";
...
TEST(ff1, base2_b)
{
    ...
    const char PT[] = "00000111011010010101111110011110001011111000110100000101001010001100001101111000010000101011100100010111011101001010010100101010100011010101010000101111111001111100110100001100011001011010010000110";
...
TEST(ff1, base2_c)
{
    ...
    const char PT[] = "";
...
TEST(ff1, base2_d)
{
    ...
    const char PT[] = "";
...
TEST(ff1, base2_e)
{
    ...
    const char PT[] = "";
